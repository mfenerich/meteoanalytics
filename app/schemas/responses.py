...
class TimeSeriesFullResponse(BaseModel):
    ...
    identificacion: Optional[str] = Field(
        None, description="Identification code of the station.", json_schema_extra={"example": "89064"}
    )
    ...
    latitud: Optional[float] = Field(
        None, description="Latitude of the station.", json_schema_extra={"example": -62.66325}
    )
    longitud: Optional[float] = Field(
        None, description="Longitude of the station.", json_schema_extra={"example": -60.38959}
    )
    altitud: Optional[float] = Field(
        None, description="Altitude in meters.", json_schema_extra={"example": 12.0}
    )
    srs: Optional[str] = Field(
        None, description="Spatial Reference System.", json_schema_extra={"example": "WGS84"}
    )
    alt_nieve: Optional[float] = Field(
        None, description="Snow altitude in meters.", json_schema_extra={"example": None}
    )
    ddd: Optional[float] = Field(
        None, description="Wind direction (degrees).", json_schema_extra={"example": 237}
    )
    dddstd: Optional[float] = Field(
        None, description="Standard deviation of wind direction.", json_schema_extra={"example": 66}
    )
    ...
    ins: Optional[float] = Field(
        None, description="Incoming solar radiation in W/m².", json_schema_extra={"example": None}
    )
    lluv: Optional[float] = Field(
        None, description="Rainfall (mm).", json_schema_extra={"example": 0.0}
    )
    pres: Optional[float] = Field(
        None, description="Atmospheric pressure in hPa.", json_schema_extra={"example": 990.4}
    )
    ...
    tmn: Optional[float] = Field(
        None, description="Minimum temperature in Celsius.", json_schema_extra={"example": 1.1}
    )
    tmx: Optional[float] = Field(
        None, description="Maximum temperature in Celsius.", json_schema_extra={"example": 1.8}
    )
    ts: Optional[float] = Field(
        None, description="Surface temperature in Celsius.", json_schema_extra={"example": 4.3}
    )
    tsb: Optional[float] = Field(
        None, description="Soil baseline temperature in Celsius.", json_schema_extra={"example": None}
    )
    tsmn: Optional[float] = Field(
        None, description="Minimum soil temperature in Celsius.", json_schema_extra={"example": None}
    )
    tsmx: Optional[float] = Field(
        None, description="Maximum soil temperature in Celsius.", json_schema_extra={"example": None}
    )
    vel: Optional[float] = Field(
        None, description="Wind speed in m/s.", json_schema_extra={"example": 1.9}
    )
    velx: Optional[float] = Field(
        None, description="Extreme wind speed in m/s.", json_schema_extra={"example": 3.6}
    )
    ...
    ir_solar: Optional[float] = Field(
        None, description="Infrared solar radiation.", json_schema_extra={"example": 0.0}
    )
    neta: Optional[float] = Field(
        None, description="Net radiation.", json_schema_extra={"example": 0.0}
    )
    par: Optional[float] = Field(
        None, description="Photosynthetically active radiation.", json_schema_extra={"example": 0.0}
    )
    tcielo: Optional[float] = Field(
        None, description="Sky temperature in Celsius.", json_schema_extra={"example": 0.0}
    )
    ttierra: Optional[float] = Field(
        None, description="Ground temperature in Celsius.", json_schema_extra={"example": 0.0}
    )
