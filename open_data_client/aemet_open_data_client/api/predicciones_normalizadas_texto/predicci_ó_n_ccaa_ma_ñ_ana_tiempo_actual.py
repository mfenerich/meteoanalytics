...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/prediccion/ccaa/manana/{ccaa}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Predicción CCAA mañana. Tiempo actual.
     ...
     Predicción para la comunidad autónoma que se pasa como parámetro para el día siguiente a la fecha de
    la petición. En el caso de el producto no se hubiera elaborado todavía en la fecha de petición se
    retornará el último producto elaborado. Periodicidad de actualización: continuamente.
