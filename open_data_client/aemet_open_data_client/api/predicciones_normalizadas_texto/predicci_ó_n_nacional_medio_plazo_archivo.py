...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/prediccion/nacional/medioplazo/elaboracion/{fecha}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Predicción nacional medio plazo. Archivo.
     ...
     Predicción nacional para el medio plazo siguiente a la fecha de elaboración. En este caso, la fecha
