...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/prediccion/provincia/manana/{provincia}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Predicción provincial e insular mañana. Tiempo actual.
     ...
     Predicción del día siguiente para la provincia o isla que se pasa como parámetro. En el caso de que
    este producto no se haya elaborado todavía en el día actual, se retorna el último elaborado.
