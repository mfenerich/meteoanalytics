...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/prediccion/ccaa/pasadomanana/{ccaa}/elaboracion/{fecha}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Predicción CCAA pasado mañana. Archivo.
     ...
     Predicción para la comunidad autónoma que se pasa como parámetro (ccaa) y validez para pasado mañana
    a partir de la fecha de elaboración que se pasa como parámetro (fecha). Periodicidad de
