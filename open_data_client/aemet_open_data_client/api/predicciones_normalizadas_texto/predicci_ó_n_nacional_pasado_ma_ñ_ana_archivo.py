...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/prediccion/nacional/pasadomanana/elaboracion/{fecha}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Predicción nacional pasado mañana. Archivo.
     ...
     Predicción nacional para pasado mañana siguiente a la fecha de elaboración. En este caso, la fecha
    de elaboración es la fecha que se pasa como parámetro. Actualización diaria.
