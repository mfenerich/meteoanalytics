...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/prediccion/ccaa/manana/{ccaa}/elaboracion/{fecha}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Predicción CCAA mañana. Archivo.
     ...
     Predicción para la comunidad autónoma que se pasa como parámetro (ccaa) con validez para el día
    siguiente a la fecha de elaboración que se pasa como parámetro (fecha). Periodicidad de
