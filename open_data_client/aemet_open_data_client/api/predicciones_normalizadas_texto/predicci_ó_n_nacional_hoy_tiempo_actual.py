...
def sync_detailed(
    *,
    ...
    """Predicción nacional hoy. Última elaborada.
     ...
     Predicción nacional para el día actual a la fecha de elaboración en formato texto. Actualización
    diaria. Hay días en los que este producto no se realiza. En ese caso se devuelve la predicción
