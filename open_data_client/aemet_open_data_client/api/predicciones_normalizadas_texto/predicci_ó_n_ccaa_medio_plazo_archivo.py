...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/prediccion/ccaa/medioplazo/{ccaa}/elaboracion/{fecha}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Predicción CCAA medio plazo. Archivo.
     ...
     Predicción de mediio plazo para la comunidad autónoma que se pasa como parámetro (ccaa) a partir de
    la fecha de elaboración que se pasa como parámetro (fecha). Periodicidad de actualización:
    continuamente.
