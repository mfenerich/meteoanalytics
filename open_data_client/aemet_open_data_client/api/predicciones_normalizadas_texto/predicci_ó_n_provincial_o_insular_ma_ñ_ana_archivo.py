...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/prediccion/provincia/manana/{provincia}/elaboracion/{fecha}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Predicción provincial e insular mañana. Archivo.
     ...
     Predicción del día siguiente a la fecha que se pasa como parámetro para la provincia o isla que se
    pasa como parámetro. Actualización continua y fija a las 14:00 Hora Oficial Peninsular del día que
