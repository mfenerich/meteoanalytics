...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/incendios/mapasriesgo/estimado/area/{area}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Mapa de niveles de riesgo estimado meteorológico de incendios forestales.
     ...
     Último mapa elaborado de niveles de riesgo estimado meteorológico de incendios forestales para el
    área pasada por parámetro.
