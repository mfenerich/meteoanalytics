...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/incendios/mapasriesgo/previsto/dia/{dia}/area/{area}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Mapa de niveles de riesgo previsto meteorológico de incendios forestales.
     ...
     Mapa elaborado de niveles de riesgo estimado meteorológico de incendios forestales para el día y el
    área pasados por parámetro.
