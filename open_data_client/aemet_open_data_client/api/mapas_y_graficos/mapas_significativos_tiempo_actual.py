...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/mapasygraficos/mapassignificativos/fecha/{fecha}/{ambito}/{dia}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Mapas significativos. Tiempo actual.
     ...
     Mapas significativos de ámbito nacional o CCAA, para una fecha dada y ese mismo día (D+0),  al día
    siguiente (D+1) o a los dos días (D+2), en el periodo horario de (00_12) ó (12-24). Hasta el
    22/01/2020.
