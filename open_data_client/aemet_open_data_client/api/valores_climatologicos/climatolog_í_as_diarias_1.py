...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/valores/climatologicos/diarios/datos/fechaini/{fecha_ini_str}/fechafin/{fecha_fin_str}/todasestaciones",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Climatologías diarias.
     ...
     Valores climatológicos de todas las estaciones para el rango de fechas seleccionado. Periodicidad: 1
    vez al día.
