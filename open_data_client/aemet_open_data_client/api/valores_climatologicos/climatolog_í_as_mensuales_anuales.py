...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/valores/climatologicos/mensualesanuales/datos/anioini/{anio_ini_str}/aniofin/{anio_fin_str}/estacion/{idema}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Climatologías mensuales anuales.
     ...
     Valores medios mensuales y anuales de los datos climatológicos para la estación y el periodo de años
    pasados por parámetro. Periodicidad de actualización: 1 vez al día.
    ...
    kwargs = _get_kwargs(
        anio_ini_str=anio_ini_str,
        anio_fin_str=anio_fin_str,
        idema=idema,
    )
