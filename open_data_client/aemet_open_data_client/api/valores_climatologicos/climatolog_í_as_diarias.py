...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/valores/climatologicos/diarios/datos/fechaini/{fecha_ini_str}/fechafin/{fecha_fin_str}/estacion/{idema}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Climatologías diarias.
     ...
     Valores climatológicos para el rango de fechas y la estación seleccionada. Periodicidad: 1 vez al
    día.
