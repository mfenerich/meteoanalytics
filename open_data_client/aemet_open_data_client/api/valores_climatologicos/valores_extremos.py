...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/valores/climatologicos/valoresextremos/parametro/{parametro}/estacion/{idema}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Valores extremos.
     ...
     Valores extremos para la estación y la variable (precipitación, temperatura y viento) pasadas por
    parámetro. Periodicidad: 1 vez al día.
