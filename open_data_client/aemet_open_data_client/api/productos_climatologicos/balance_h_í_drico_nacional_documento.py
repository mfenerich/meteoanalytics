...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/productos/climatologicos/balancehidrico/{anio}/{decena}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Balance hídrico nacional (documento).
     ...
     Se obtiene, para la decema y el año pasados por parámetro, el Boletín Hídrico Nacional que se
    elabora cada diez días. Se presenta información resumida de forma distribuida para todo el
    territorio nacional de diferentes variables, en las que se incluye informaciones de la precipitación
    y la evapotranspiración potencial acumuladas desde el 1 de septiembre.
