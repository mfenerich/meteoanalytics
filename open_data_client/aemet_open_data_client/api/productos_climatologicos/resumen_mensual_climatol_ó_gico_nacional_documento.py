...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/productos/climatologicos/resumenclimatologico/nacional/{anio}/{mes}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Resumen mensual climatológico nacional (documento).
     ...
     Resumen climatológico nacional, para el año y mes pasado por parámetro, sobre el estado del clima y
    la evolución de las principales variables climáticas, en especial temperatura y precipitación, a
    nivel mensual, estacional y anual.
