...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/productos/climatologicos/capasshape/{tipoestacion}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Capas SHAPE de estaciones climatológicas de AEMET.
     ...
     Capas SHAPE de las distintas estaciones climatológicas de AEMET: automáticas, completas,
    pluviométricas y termométricas.
