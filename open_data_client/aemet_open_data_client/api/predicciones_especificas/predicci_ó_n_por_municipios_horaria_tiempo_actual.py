...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/prediccion/especifica/municipio/horaria/{municipio}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Predicción por municipios horaria. Tiempo actual.
     ...
     Predicción horaria para el municipio que se pasa como parámetro (municipio). Presenta la información
    de hora en hora hasta 48 horas.<br><br> <a
