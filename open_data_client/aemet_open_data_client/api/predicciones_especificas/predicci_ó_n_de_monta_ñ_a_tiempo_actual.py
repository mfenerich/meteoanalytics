...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/prediccion/especifica/montaña/pasada/area/{area}/dia/{dia}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Predicción de montaña. Tiempo actual.
     ...
     Predicción meteorológica para la zona montañosa que se pasa como parámetro (area) con validez para
    el día (día).  Periodicidad de actualización: continuamente.<br><br> <a
    href='https://opendata.aemet.es/centrodedescargas/rssatom'
        target='_blank'>Canales RSS</a> disponibles:
            ...
            <li>Predicción montaña actual</li>
