...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/prediccion/especifica/playa/{playa}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Predicción para las playas. Tiempo actual.
     ...
     La predicción diaria de la playa que se pasa como parámetro. Establece el estado de nubosidad para
    unas horas determinadas, las 11 y las 17 hora oficial. Se analiza también si se espera precipitación
    en el entorno de esas horas, entre las 08 y las 14 horas y entre las 14 y 20 horas.<br><br> <a
    href='https://opendata.aemet.es/centrodedescargas/rssatom'
        target='_blank'>Canales RSS</a> disponibles:
            <ul>
            <li>Predicción playa</li>
            </ul>
