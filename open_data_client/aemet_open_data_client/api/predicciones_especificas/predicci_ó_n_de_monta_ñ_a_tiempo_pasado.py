...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/prediccion/especifica/montaña/pasada/area/{area}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Predicción de montaña. Tiempo pasado.
     ...
     Breve resumen con lo más significativo de las condiciones meteorológicas registradas en la zona de
    montaña que se pasa como parámetro (area) en las últimas 24-36 horas.<br><br> <a
    href='https://opendata.aemet.es/centrodedescargas/rssatom'
        target='_blank'>Canales RSS</a> disponibles:
            <ul>
            <li>Predicción montaña todos</li>
            <li>Predicción montaña pasado</li>
            <li>Predicción montaña área</li>
            </ul>
