...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/prediccion/especifica/municipio/diaria/{municipio}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Predicción por municipios diaria. Tiempo actual.
     ...
     Predicción diaria para el municipio que se pasa como parámetro (municipio). Periodicidad de
    actualización: continuamente.<br><br> <a href='https://opendata.aemet.es/centrodedescargas/rssatom'
        target='_blank'>Canales RSS</a> disponibles:
            <ul>
            <li>Predicción municipio</li>
            </ul>
