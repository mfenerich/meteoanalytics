...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/prediccion/especifica/uvi/{dia}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Predicción de radiación ultravioleta (UVI).
     ...
     Predicción de Índice de radiación UV máximo en condiciones de cielo despejado para el día
    seleccionado.<br><br> <a href='https://opendata.aemet.es/centrodedescargas/rssatom'
        target='_blank'>Canales RSS</a> disponibles:
            <ul>
            <li>Predicción de radiación ultravioleta (UVI)</li>
            </ul>
