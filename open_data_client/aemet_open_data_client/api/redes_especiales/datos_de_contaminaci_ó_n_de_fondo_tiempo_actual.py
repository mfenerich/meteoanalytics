...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/red/especial/contaminacionfondo/estacion/{nombre_estacion}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Datos de contaminación de fondo. Tiempo actual.
     ...
     Ficheros diarios con datos diezminutales de la estación de la red de contaminación de fondo
    EMEP/VAG/CAMP pasada por parámetro, de temperatura, presión, humedad, viento (dirección y
    velocidad), radiación global, precipitación y 4 componentes químicos: O3,SO2,NO,NO2 y PM10. Los
    datos se encuentran en formato FINN (propio del Ministerio de Medio Ambiente). Periodicidad: cada
    hora.
