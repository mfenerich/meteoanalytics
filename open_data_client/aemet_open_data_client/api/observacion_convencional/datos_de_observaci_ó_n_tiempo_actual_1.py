...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/observacion/convencional/datos/estacion/{idema}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Datos de observación. Tiempo actual.
     ...
     Datos de observación horarios de las últimas 12 horas de la estación meterológica que se pasa como
    parámetro (idema). Frecuencia de actualización: continuamente. <br><br> <a
    href='https://opendata.aemet.es/centrodedescargas/rssatom'
        target='_blank'>Canales RSS</a> disponibles:
            <ul>
            <li>Observación convencional horaria</li>
            </ul>
