...
def sync_detailed(
    *,
    ...
    """Datos de observación. Tiempo actual.
     ...
     Datos de observación horarios de las últimas 12 horas todas las estaciones meteorológicas de las que
    se han recibido datos en ese período. Frecuencia de actualización: continuamente. <br><br> <a
